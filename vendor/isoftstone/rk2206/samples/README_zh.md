...
| B10  | 网络开发       | wifi_ap              | [wifi AP模式](./b10_wifi_AP)                                 |
| B11  | 网络开发       | wifi_sta             | [wifi STA模式](./b11_wifi_STA)                               |
| B12  | 网络开发       | wifi_udp             | [UDP实验](./b12_wifi_udp/README_zh.md)                       |
| B13  | 网络开发       | wifi_tcp             | [TCP实验](./b13_wifi_tcp/README_zh.md)                       |
| B14  | 网络开发       | wifi_ap_tcp_server   | [wifi tcp 服务端](./b14_wifi_ap_tcp_server)                  |
| B15  | 网络开发       | wifi_ap_udp_server   | [wifi udp 服务端](./b15_wifi_ap_udp_server)                  |
| B16  | 网络开发       | wifi_pair            | [wifi 配网](./b16_wifi_pair)                                 |
| B17  | 基础外设       | watchdog             | [看门狗实验](./b17_watchdog/README_zh.md)                    |
| B18  | 基础外设       | reboot               | [复位实验](./b18_reboot/README_zh.md)                        |
...
| E1   | 物联网综合实验 | iot_smart_home_hwiot | [基于华为云IOT平台智慧家居实验](./e1_iot_smart_home_hwiot)   |
